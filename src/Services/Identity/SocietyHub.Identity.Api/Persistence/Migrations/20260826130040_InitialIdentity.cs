        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSignedInAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsDisabled = table.Column<bool>(type: "bit", nullable: false),
                    IsPlatformOperator = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PinHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    PinSalt = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    ...
                    ActiveGuardUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ShiftStartedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuardDevices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Relationship = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuardDevices_Society_Device",
                table: "GuardDevices",
                columns: new[] { "SocietyId", "DeviceIdentifier" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_Society_User",
