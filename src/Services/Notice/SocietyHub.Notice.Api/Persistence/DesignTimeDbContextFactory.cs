...
/// </summary>
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<NoticeDbContext>
{
    public NoticeDbContext CreateDbContext(string[] args)
    {
        var options = new DbContextOptionsBuilder<NoticeDbContext>()
            .UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=societyhub-notice-design;")
            .Options;

        return new NoticeDbContext(options, new DesignTimeTenantContext());
    }
